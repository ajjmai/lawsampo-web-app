...
import ResultTablePaginationActions from '../../../facet_results/ResultTablePaginationActions'
 ...
 */
class ResultTableStatuteHistory extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
...
ResultTableStatuteHistory.propTypes = {
...
export const ResultTableComponent = ResultTableStatuteHistory

export default withStyles(styles)(ResultTableStatuteHistory)
