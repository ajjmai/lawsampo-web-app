...
import {
  countQuery,
  countQueryStatuteHistory,
  facetResultSetQuery,
  instanceQuery,
  facetResultSetQueryStatuteHistory
...
export const getPaginatedResultsStatuteHistory = ({
  backendSearchConfig,
  resultClass,
  page,
  pagesize,
  ...
  let q = facetResultSetQueryStatuteHistory
  const perspectiveConfig = backendSearchConfig[resultClass]
  const {
    endpoint,
    facets,
...
export const getResultCountStatuteHistory = ({
  backendSearchConfig,
  resultClass,
  constraints,
  resultFormat
}) => {
  let q = countQueryStatuteHistory
  const perspectiveConfig = backendSearchConfig[resultClass]
  const {
    endpoint,
    defaultConstraint = null
